        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">             
              ...
              <li class="dropdown">
        			  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Selamat Datang, <?php  echo $this->session->userdata('admin_nama');?> <span class="caret"></span></a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <!-- <li class="<?php if($page == 'jenis_surat'){echo 'active';} ?>">
            ...
            <li class="<?php if($page == 'agenda_aktif'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>admin/agenda_aktif">
                <i class="fa fa-calendar"></i> <span>Daftar Agenda Aktif</span>
              </a>
            </li>
            <li class="<?php if($page == 'agenda_nonaktif'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>admin/agenda_nonaktif">
                <i class="fa fa-calendar-o"></i> <span>Daftar Agenda Tidak Aktif</span>
              </a>
            </li>
            <li class="<?php if($page == 'agenda_marquee'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>admin/agenda_marquee">
                <i class="fa fa-newspaper-o"></i> <span>Daftar Agenda Tulisan Berjalan</span>
              </a>
            </li>
